...
export class UserAuthService {
  ...
  async login(usernameOrEmail: string, password: string, callBackFunction?:(error)=>void): Promise<any> {
    ...
    try {
      const tokenResponse: TokenResponse = await firstValueFrom(observable).catch((e)=>callBackFunction(e))
      if (tokenResponse) {
